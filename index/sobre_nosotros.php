...
<?php
  ...
  <button type="button" class="btn btn-danger" onclick="location.href='loginSU.php'" style="position: absolute; top:10; right:10;">Registrarse</button>
    ...
    <H1 style="position: absolute; top:200; left: 150;">Somos programadores</H1>
    <p style="position: absolute; top:250; left: 150;">
            Somos unos chicos pobres
    </p>
